...
def introduction():
    ...
    LBL_GAME_DETAILS = tk.Label(master=FRM_USER_INFO, text="The goal of this practice is to click on the black square as quickly as possible before the timer runs out.", font=("Arial", 13))
    LBL_GAME_DETAILS.place(width=280, x=140, y=150)

def game_levels():
    #functions used to help display and choose difficulty of level
    global FRM_LEVELS
    global LBL_LEVEL
    global BTN_EASY
    global BTN_INTERMEDIATE
...
def game_layout(username: str, difficulty: List):
    #functions to help display game layout
    global FRM_INFO
    global LBL_USERNAME
    global LBL_POINTS
    global LBL_TIME
